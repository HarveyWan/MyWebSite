...
namespace KDMSCommon
{
    ...
    {
        //基本设置
        static private string path = @"ftp://" + "114.55.105.123:2211" + "/";    //目标路径
        static private string ftpip = "114.55.105.123";    //ftp IP地址
        static private string username = "zx_data";   //ftp用户名
        static private string password = "h3k94e";   //ftp密码
